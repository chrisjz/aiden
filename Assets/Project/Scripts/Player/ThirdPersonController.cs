...
/* Modified from Unity Technologies > Robot Kyle
 */
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            if (_input.strafeMovement)
            {
                ...
                // rotate player to face forward direction only when moving forward
                if (_input.move.y > 0) // Only rotate when moving forward (positive y)
                {
